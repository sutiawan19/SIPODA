...
import { MOCK_STATS } from "@/lib/constants/mockData";
...
const FADE_IN_ANIMATION_VARIANTS = {
  ...
  show: { opacity: 1, filter: "blur(0px)", transition: { duration: 1, ease: [0.16, 1, 0.3, 1] } }
};
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10 w-full flex flex-col items-center text-center">
            ...
            >
              ...
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} className="flex flex-col sm:flex-row items-center gap-4">
                <Link
                  href="/institutions"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-neutral-950 text-white rounded-xl font-medium hover:bg-neutral-800 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-md"
                >
                  Mulai Survei
                ...
                <Link
                  href="#how-it-works"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-neutral-900 border border-neutral-200 rounded-xl font-medium hover:bg-neutral-50 transition-all hover:scale-[1.02] active:scale-[0.98]"
                >
            ...
            >
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} className="flex flex-col border-l border-neutral-200 pl-8">
                ...
                <div className="text-6xl font-bold text-neutral-950 mb-2 tracking-tighter">
                  <AnimatedCounter value={MOCK_STATS.totalResponses} formatter={formatNumber} />+
                </div>
              ...
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} className="flex flex-col border-l border-neutral-200 pl-8">
                ...
                <div className="text-6xl font-bold text-neutral-950 mb-2 tracking-tighter">
                  <AnimatedCounter value={MOCK_STATS.totalInstitutions} />
                </div>
                <div className="text-neutral-500">Entitas terdaftar</div>
              </motion.div>
              ...
              <motion.div variants={FADE_UP_ANIMATION_VARIANTS} className="flex flex-col border-l border-neutral-200 pl-8">
                ...
                <div className="text-6xl font-bold text-neutral-950 mb-2 tracking-tighter">
                  <AnimatedCounter value={MOCK_STATS.averageSatisfaction * 10} formatter={(v) => (v/10).toFixed(1)} />
                </div>
        ...
        <section className="py-40 bg-neutral-950 text-white relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
            ...
            >
              ...
              <Link
                href="/institutions"
                className="inline-flex items-center justify-center px-10 py-5 bg-white text-neutral-950 rounded-xl font-semibold text-lg hover:bg-neutral-100 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
