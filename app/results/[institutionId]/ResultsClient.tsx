...
const SENTIMENT_COLORS = ['#171717', '#d4d4d4'];
...
export function ResultsClient({ result }: ResultsClientProps) {
              ...
              <div className="h-[300px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={result.distribution} layout="vertical" margin={{ top: 0, right: 20, left: 0, bottom: 0 }}>
                    ...
                    <YAxis dataKey="score" type="category" tickFormatter={(val) => `Bintang ${val}`} width={100} axisLine={false} tickLine={false} tick={{fill: '#737373', fontSize: 14}} />
                    <Tooltip 
                      cursor={{fill: '#f5f5f5'}}
